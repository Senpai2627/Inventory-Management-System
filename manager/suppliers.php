...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_supplier'])) {
        ...
        if ($stmt->execute()) {
            ...
            logAction($action, $tableName, $newSupplierId, null, $newValue);
    ...
    if (isset($_POST['update_supplier'])) {
        ...
        $currentStmt = $conn->prepare("SELECT name, contact_person, email, phone, address FROM suppliers WHERE id = ?");
        ...
        if ($stmt->execute()) {
            ...
            $oldValue = json_encode($currentData, JSON_PRETTY_PRINT);
            $newValue = json_encode([
                'name' => $name,
                'contact_person' => $contact,
                'email' => $email,
            ...
            logAction($action, $tableName, $id, $oldValue, $newValue);
...
if (isset($_GET['delete'])) {
    ...
    if ($count > 0) {
        ...
        // First get the supplier data for audit logging
        $currentStmt = $conn->prepare("SELECT name, contact_person, email, phone, address FROM suppliers WHERE id = ?");
        $currentStmt->bind_param("i", $id);
        $currentStmt->execute();
        $currentResult = $currentStmt->get_result();
        ...
        if ($deleteStmt->execute()) {
            ...
            logAction($action, $tableName, $id, $oldValue, null);
...
<div class="container-fluid py-4">
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="audit_logs.php?log_type=audit&action=supplier_created,supplier_updated,supplier_deleted&table_name=suppliers" 
                   class="audit-log-link me-3"
                   title="View supplier-related audit logs">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Audit log link for this supplier -->
                    <div class="mt-4 pt-3 border-top">
                        <a href="audit_logs.php?log_type=audit&table_name=suppliers&record_id=<?php echo $supplier['id']; ?>" 
                           class="audit-log-link">
                            <i class="fas fa-history me-1"></i> View activity history for this supplier
                        </a>
                    </div>
                </div>
                <div class="modal-footer">
